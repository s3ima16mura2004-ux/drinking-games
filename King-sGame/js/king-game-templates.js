...
const COMMAND_CATEGORIES = [
  ...
  },
  {
    label: "🍻 お酒・ドリンク",
    items: [
      { slots: 1, text: "{A}番の人の合図で全員一斉に乾杯する" },
      { slots: 2, text: "{A}番が{B}番に一杯(ソフトドリンクでもOK)奢る" },
      { slots: 1, text: "{A}番の人が次のドリンクの注文係になる" },
      { slots: 1, text: "{A}番の人が今夜のドリンクを1つおすすめする" },
      { slots: 2, text: "{A}番と{B}番がグラスを合わせて乾杯する" },
      { slots: 1, text: "{A}番の人が乾杯の音頭を考えて発表する" },
      { slots: 1, text: "{A}番の人が今飲んでいるものを一言で例える" },
      { slots: 2, text: "{A}番が{B}番の分もドリンクを取りに行ってあげる" },
      { slots: 1, text: "{A}番の人が次の1杯を何にするか宣言する" },
      { slots: 2, text: "{A}番と{B}番で「乾杯」の代わりに好きな掛け声を考えて言う" }
    ]
  }
];
